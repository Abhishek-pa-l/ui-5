		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Northwind Products",
									"targetURL": "#comsapmanageproducts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapmanageproducts-display": {
								"semanticObject": "comsapmanageproducts",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.manageproducts",
									"url": sap.ui.require.toUrl("com/sap/manageproducts")
								}
							}
						}
					}
